    ...
    <footer className="w-full bg-black text-white lg:p-10 p-5 mt-20 border-t border-gray-800 relative z-20">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
        ...
        <div className="lg:text-right text-center lg:w-1/3">
          <a href="mailto:hello@example.com" className="inline-block border border-white hover:border-[#defd50] hover:text-[#defd50] hover:bg-[#defd50]/10 px-6 py-3 rounded-full transition-all uppercase tracking-widest text-xs font-[font2]">
            Get In Touch
          </a>
        </div>
      </div>
